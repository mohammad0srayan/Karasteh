...
import { getAboutUsData, getContactInfoData, getCatalog } from '../api/homeApi';
import { AboutUs, ContactInfo, Catalog } from '../api/types';
...
const AboutContact: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch About Us and Contact Info
        const [about, contact] = await Promise.all([getAboutUsData(), getContactInfoData()]);
        setAboutData(about);
        setContactData(contact);

        // Fetch Catalog separately to avoid blocking About Us
        try {
        ...
        setErrorMessage('خطا در بارگذاری داده‌های درباره ما/تماس');
      }
    };
    fetchData();
  }, []);
  ...
  return (
    <div className="border border-gray-500 p-4 rounded-lg my-10">
      <div className="flex flex-col lg:flex-row lg:gap-14">
        ...
        <div className="w-full lg:w-1/2">
          {aboutData.length > 0 ? (
            <>
              ...
              <div
                className="text-blue-900 prose prose-blue"
                dangerouslySetInnerHTML={{
                  __html: aboutData[0].description || '<p>توضیحاتی در دسترس نیست</p>',
                }}
              />
            </>
          ) : (
            <div className="text-blue-900">
              <h3 className="lg:text-2xl text-xl font-bold mb-5">مجموعه کاراسته</h3>
              <p>داده‌ای برای نمایش درباره ما وجود ندارد</p>
            </div>
          )}
        ...
        {/* Contact Info, Logo, Catalog, and Social Media - Right Half */}
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start mt-10 lg:mt-0">
          ...
          <div className="flex flex-col space-y-1">
            <h2 className="text-xl text-blue-900 font-bold mb-5">راحت بخرید، مطمئن بسازید</h2>
            <div className="flex flex-col space-y-1 lg:mb-5 mb-10">
              <a href="#" className="text-base text-blue-700">
                7 روز هفته - 24 ساعته
              </a>
              {(() => {
                const validContact = contactData.find(info => info.phone_number && info.phone_number.trim());
                return validContact ? (
                  <a
                  ...
                  >
                    تلفن
                    <span>{validContact.phone_number}</span>
                  </a>
                ) : (
                  <a
              ...
              <a
                href="mailto:info@karasteh.com"
                className="flex justify-between text-base text-blue-700"
              >
                ایمیل
                <span>info@karasteh.com</span>
              </a>
            </div>
            <a
              href="/contact"
              className="text-base bg-blue-900 text-white rounded-lg px-3 py-1 hover:shadow-2xl text-center"
            >
              تماس با ما
            </a>
          </div>
            <div className="flex flex-col items-center">
              <a href="#" className="text-base text-blue-700 mb-3">
              ...
              <a
                ...
                className="text-base bg-blue-900 text-white rounded-lg px-3 py-1 hover:shadow-2xl mb-3"
              >
                دانلود کاتالوگ
              </a>
              {errorMessage && (
